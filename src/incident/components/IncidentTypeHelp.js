...
const INCIDENT_HELP = [
  ...
  },
  {
    ...
    summary: "Use for workplace concerns involving alcohol or drugs.",
  },
  {
    type: "Attendance",
    summary:
...
export default function IncidentTypeHelp({ onSelectType }) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="incident-help-overlay" onClick={() => setOpen(false)}>
          <div
          ...
          >
            <div className="incident-help-header">
              <div>
                <span className="eyebrow">INCIDENT TYPE GUIDE</span>

                <h2>Which incident type should I use?</h2>

                <p>
                  Review the descriptions below and choose the category that
                  most closely matches what occurred.
                </p>
              </div>
            ...
            <div className="incident-help-notice">
              <strong>This guide helps with documentation only.</strong> It does
              not determine discipline or replace supervisor or HR guidance.
            </div>

            <div className="incident-help-list">
              {INCIDENT_HELP.map((item) => (
                <div className="incident-help-item" key={item.type}>
                  <div>
                    <h3>{item.type}</h3>
                    <p>{item.summary}</p>
                  </div>
