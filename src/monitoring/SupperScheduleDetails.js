...
export default function SupperScheduleDetails({ schedule }) {
  return <div className="sm-schedule-details">
    ...
    {!schedule.blockedReason && schedule.configured && schedule.rangeStart && <p><strong>Calculated range:</strong> {displayDate(schedule.rangeStart)} through {displayDate(schedule.rangeEnd)}. SPARK excludes the weekdays and weeks already used.</p>}
